package com.star.template.spi.compilers;


import com.star.template.util.ClassUtils;
import com.star.template.util.StringUtils;
import com.star.template.util.UnsafeByteArrayInputStream;
import com.star.template.util.UnsafeByteArrayOutputStream;
...
public class JdkCompiler extends AbstractCompiler {
    ...
    public JdkCompiler() {
        ...
        if (compiler == null) {
            throw new IllegalStateException("Can not get system java compiler. Please run with JDK (NOT JVM)");
        }
        ...
        } catch (ClassNotFoundException e) { // 如果线程上下文的ClassLoader不能加载当前jar包中的类，则切换回jar所在的ClassLoader
